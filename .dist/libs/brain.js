  ...
  (0, _createClass3.default)(Brain, [{
    ...
    value: function handleStdoutLine(line) {
      ...
      if (line.indexOf('DEBUG') === 0) {
        ...
        _utils2.default.log('debug', { type: 'brainDebug', id: this.id, message: message, quotaUsed: this.debugLogQuotaUsed });
        return;
      }
      _utils2.default.log('debug', { action: 'receiveResponse', id: this.id, data: line, totalElapsedMs: this.usedTime });
      if (!this.allowStdout) {
